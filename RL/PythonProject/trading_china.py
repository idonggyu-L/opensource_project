...
def train_and_eval(model_class, name, **kwargs):
    ...
    save_dir = "/home/hail/PycharmProjects/PythonProject/models/china"
...
if __name__ == "__main__":
    csv_path = "/home/hail/Desktop/stock/ETF/China/510300.SS.csv"
    df = pd.read_csv(csv_path)

    split_idx = int(len(df) * 0.8)
    train_path = "/home/hail/PycharmProjects/PythonProject/env/ch/train.csv"
    eval_path = "/home/hail/PycharmProjects/PythonProject/env/ch/eval.csv"
    ...
    eval_results.to_csv("c_eval_results.csv", index=False)
