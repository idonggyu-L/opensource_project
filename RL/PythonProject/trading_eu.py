...
def train_and_eval(model_class, name, **kwargs):
    ...
    save_dir = "/home/hail/PycharmProjects/PythonProject/models/europe"
...
if __name__ == "__main__":
    csv_path = "/home/hail/Desktop/stock/ETF/EU/EUE.DE.csv"
    df = pd.read_csv(csv_path)

    split_idx = int(len(df) * 0.8)
    train_path = "/home/hail/PycharmProjects/PythonProject/env/eu/train.csv"
    eval_path = "/home/hail/PycharmProjects/PythonProject/env/eu/eval.csv"
    ...
    eval_results.to_csv("eu_eval_results.csv", index=False)
